...
import static org.newdawn.slick.geom.ShapeRenderer.draw;
import org.newdawn.slick.state.transition.FadeInTransition;
import org.newdawn.slick.state.transition.FadeOutTransition;

public class wires extends BasicGame {
    ...
    public void init(GameContainer gc) throws SlickException {
        ...
        /*  for (wire w : wires) {
            wires.add(new wire(w.getRedX(), w.getRedY(), 50, 15));
            wires.add(new wire(w.getBlueX(), w.getBlueY(), 50, 15));
            wires.add(new wire(w.getYellowX(), w.getYellowY(), 50, 15));
            wires.add(new wire(w.getWhiteX(), w.getWhiteY(), 50, 15));
        }*/
    ...
    public void update(GameContainer gc, int i) throws SlickException {
        ...
        if (allgood == true) {
            if (s4.contains(mx, my) && in.isMousePressed(Input.MOUSE_LEFT_BUTTON)) //change screen to walking guy
            {
                //  sbg.enterState(1,new FadeInTransition(), new FadeOutTransition());
    ...
    public void render(GameContainer gc, Graphics g) throws SlickException {
        ...
        if (keepr == true && keepb == true && keepy == true && keepw == true) {
            ...
            g.fill(s1);
            g.setColor(Color.yellow);
            Circle s4 = new Circle(90, 500, 50, 50);
            g.fill(s4);
            g.setColor(Color.red);
    ...
    public static void main(String args[]) throws SlickException {
        wires game = new wires("Testing Game");
